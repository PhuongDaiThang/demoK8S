        ...
        String html = """
            ...
            <body>
                <div class="container">
                    ...
                    <h2>📋 Tổng quan</h2>
                    <p>DemoK8s là một ứng dụng Spring Boot để quản lý Kubernetes labs và pods. API này cung cấp các endpoint để tạo và quản lý các môi trường lab trong Kubernetes cluster.</p>
                    ...
                    <div class="endpoint">
                        ...
                        <h3>Tạo Lab Mới</h3>
                        <p>Tạo một lab mới trong Kubernetes cluster với script setup tùy chỉnh.</p>
